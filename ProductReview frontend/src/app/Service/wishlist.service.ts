...
export class WishlistService {
  ...
  addToWishlist(productId: any): Observable<any> {
     ...
     console.log('${this.baseUrl}/${this.addwhistlistUrl}/${productId}' + '---------------wishlist url');
     return this.httpService
      .post(`${this.baseUrl}/${this.addwhistlistUrl}/${productId}`, {}, {headers: new HttpHeaders({token: localStorage.token})})
      .pipe(
        tap(() => {
